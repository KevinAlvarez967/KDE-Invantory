...
const API = '../../Core/api/Empleado/Usuario.php?action=';
...
function checkUsuarios()
{
    ...
    .done(function( response ) {    
        ...
        if ( current == '/KDE-Invantory/KDE-INVENTARY/views/Empleado/Registrarse.php' ) {
            // Si ya existe un usuario registrado se envía a iniciar sesión, de lo contrario se pide crear el primero.
            if ( response.status ) {
                sweetAlert( 3, response.message, '/KDE-Invantory/KDE-INVENTARY/views/Empleado/Index.php' );
            } else {
            ...
            if ( response.status ) {
                ...
                sweetAlert( 3, response.exception, '/KDE-Invantory/KDE-INVENTARY/views/Empleado/Registrarse.php' );
            }
        }
    })
    .fail(function( jqXHR ) {
